// src/app/settings/components/separated-logging-settings-card.tsx
"use client"
...
export function SeparatedLoggingSettingsCard() {
  // For now, use the old settings until context is updated
  const {
    logRetentionDays: dbLogRetentionDays = 30,
    setLogRetentionDays: setDbLogRetentionDays = () => {},
    maxLogFileSize,
    setMaxLogFileSize,
    logLevel: dbLogLevel = "info",
    setLogLevel: setDbLogLevel = () => {},
    enableLogRotation,
  ...
  // Local state for the new file logging settings (until context is updated)
  const [fileLogRetentionDays, setFileLogRetentionDays] = useState(7)
  const [fileLogLevel, setFileLogLevel] = useState("info")

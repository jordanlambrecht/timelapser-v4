  ...
  return (
    <span
      className={`px-3 py-1 rounded-full text-sm font-medium ${
        colors[status as keyof typeof colors] || colors.total
      }`}
    >
      {count} {status}
    </span>
...
export default function TestsPage() {
  ...
  const groupedResults =
    testData?.summary?.results.reduce((acc, result) => {
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-4'>
            ...
            <div className='text-center'>
              <div className='text-2xl font-bold text-gray-600'>
                {testData.summary.duration.toFixed(1)}s
              </div>
              ...
              <div className='w-32 bg-gray-200 rounded-full h-2'>
                <div
                  className={`h-2 rounded-full ${
                    getSuccessRate(testData.summary) >= 80
                      ? "bg-green-500"
                      : getSuccessRate(testData.summary) >= 60
                      ? "bg-yellow-500"
                      : "bg-red-500"
                  }`}
              ...
              <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center gap-4'>
                  <div className='flex gap-2'>
                    ...
                    {stats.error > 0 && (
                      <StatusBadge status='error' count={stats.error} />
                    )}
                  </div>

...
import { Layers, Plus, Grid3X3, AlertCircle, Loader2 } from "lucide-react"
...
export function OverlayPresetsCard() {
  ...
  const { presets, loading, error, createPreset, updatePreset, deletePreset } =
    useOverlayPresets()

  const handleCreateNew = () => {
    router.push("/overlays/create")
  }
    ...
    <>
      <Card className='transition-all duration-300 glass hover:glow'>
        <CardHeader>
          ...
          <CardDescription>
            Create and manage overlay presets for timelapses. Configure text,
            weather data, and image overlays with custom positioning.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className='space-y-6'>
          ...
          <Alert className='border-cyan/30 bg-cyan/10'>
            ...
            <AlertDescription className='text-sm text-cyan'>
              Built-in presets cannot be deleted but can be duplicated as custom
              presets. Overlay presets work with any camera resolution and are
              applied after image capture.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
          ...
          <DialogHeader>
            <DialogTitle className='text-xl font-semibold flex items-center space-x-2'>
              ...
              <span className='gradient-text'>
                {selectedPreset
                  ? "Edit Overlay Preset"
                  : "Create New Overlay Preset"}
              </span>
            </DialogTitle>
            <DialogDescription className='text-muted-foreground'>
              Configure overlay elements and their positions for your timelapse.
              You can add multiple overlay elements in different positions.
            </DialogDescription>
          </DialogHeader>

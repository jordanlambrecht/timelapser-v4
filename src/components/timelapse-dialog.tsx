...
interface NewTimelapseDialogProps {
  isOpen: boolean
  onClose: () => void
...
export function NewTimelapseDialog({
  isOpen,
  onClose,
  onConfirm,
  cameraId,
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <Switch
                ...
                onCheckedChange={(checked) => setConfig(prev => ({ ...prev, useTimeWindow: checked }))}
                disabled={loading}
              />
              <div className="flex items-center space-x-2">
                <Clock className="w-4 h-4 text-cyan" />
                <Label htmlFor="useTimeWindow" className="text-white font-medium">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setConfig(prev => ({ ...prev, timeWindowStart: e.target.value }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setConfig(prev => ({ ...prev, timeWindowEnd: e.target.value }))}
                      className="bg-black/20 border-cyan/30 text-white"
                      disabled={loading}
                    />
                  </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <Switch
                ...
                onCheckedChange={(checked) => setConfig(prev => ({ ...prev, useAutoStop: checked }))}
                disabled={loading}
              />
              <div className="flex items-center space-x-2">
              ...
              <div className="ml-7 space-y-4 p-4 bg-purple/5 border border-purple/20 rounded-lg">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setConfig(prev => ({ ...prev, autoStopAt: e.target.value }))}

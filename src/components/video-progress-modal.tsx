// src/components/video-progress-modal.tsx
...
export function VideoProgressModal({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const progressInCurrentStep = Math.min(
        stepProgress / currentStepDuration,
        1
      )
      const overallProgress =
        ((completedSteps + progressInCurrentStep) / steps.length) * 100
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent
        className='glass-strong border-purple-muted/50 max-w-lg pointer-events-auto'
      ...
      >
        ...
        <div className='space-y-6 mt-6'>
          ...
          <div className='space-y-4'>
            ...
            <Progress value={progress} className='h-3 bg-purple-muted/20' />

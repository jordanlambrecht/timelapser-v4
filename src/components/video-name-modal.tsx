        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          <div className="space-y-4">
            <div className="flex items-center space-x-2 text-sm text-grey-light/70">
              ...
              <span>Creating video from <strong className="text-white">{cameraName}</strong> images</span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-grey-light/60">
                The final filename will be: <span className="font-mono text-cyan/80">{videoName}.mp4</span>
              </p>
            </div>

            <div className="p-4 bg-purple/10 border border-purple/20 rounded-xl">
              <h4 className="text-sm font-medium text-white mb-2">Video Settings</h4>

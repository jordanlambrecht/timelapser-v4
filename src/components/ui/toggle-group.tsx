...
const toggleGroupVariants = cva(
  "relative inline-flex items-center rounded-lg shadow-sm transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-within:ring-offset-background",
  {
    variants: {
      colorTheme: {
        pink: "",
...
const optionVariants = cva(
  "relative z-10 flex-1 flex items-center justify-center text-sm font-medium transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 rounded-sm",
  {
    variants: {
      size: {
        sm: "px-2 py-1.5",
    ...
    return (
      <div className='space-y-2'>
        ...
        >
          ...
          {selectedIndex >= 0 && (
            <div
              className={indicatorVariants({ colorTheme, borderNone })}

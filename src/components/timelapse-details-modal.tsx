...
export const TimelapseDetailsModal = memo(function TimelapseDetailsModal({
  isOpen,
  onClose,
  timelapseId,
  cameraName,
  ...
  const MemoizedImageRow = memo(({ image }: { image: TimelapseImage }) => (
    <SelectableTableRow
      key={`image-${image.id}`}
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      setTimelapse((prev) => (prev ? { ...prev, name: newName.trim() } : null))
  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose} className={"sm:max-w-4xl"}>
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='glass p-4 rounded-xl border border-purple-muted/20'>
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                          ...
                          <div>
                            <span className='text-grey-light/70'>Status:</span>
                            <div>
                    ...
                    <GlassTable variant='compact' className='min-h-[400px]'>
                      <GlassTableHeader sticky>
                        <tr>
                          ...
                          <GlassTableHeaderCell>Captured</GlassTableHeaderCell>
                      ...
                      <GlassTableBody>
                        {images.map((image) => (
                          <MemoizedImageRow key={`image-${image.id}`} image={image} />
                        ))}
                      </GlassTableBody>
                    </GlassTable>
                  )}
        ...
        <AlertDialogContent className='glass-strong border-purple-muted/50'>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              available images from this timelapse. The process may take several
              minutes.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

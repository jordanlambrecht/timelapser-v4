...
class TestSmallImageGenerator:
    ...
    def test_generate_small_image_success(self, small_image_generator, sample_image_path, sample_output_path):
        """Test successful small image generation."""
        # Mock the validation and generation process
        with patch('app.services.thumbnail_pipeline.generators.small_image_generator.validate_image_file') as mock_validate:
            ...
            with patch('PIL.Image.open') as mock_open:
                ...
                mock_img.resize.assert_called_once_with((800, 600), Image.Resampling.LANCZOS)
                mock_resized.save.assert_called_once()

    def test_generate_small_image_invalid_source(self, small_image_generator, sample_output_path):
        """Test small image generation with invalid source file."""
        with patch('app.services.thumbnail_pipeline.generators.small_image_generator.validate_image_file') as mock_validate:
            mock_validate.return_value = False
            
            result = small_image_generator.generate_small_image(
                source_path="/nonexistent/file.jpg",
                output_path=sample_output_path
            )
    ...
    def test_generate_small_image_pil_error(self, small_image_generator, sample_image_path, sample_output_path):
    ...
    def test_generate_small_image_creates_output_directory(self, small_image_generator, sample_image_path, temp_dir):
    ...
    def test_small_image_aspect_ratio_handling(self, small_image_generator, sample_output_path):
    ...
    def test_small_image_upscaling_handling(self, small_image_generator, sample_output_path):
    ...
    def test_generate_small_image_with_metadata(self, small_image_generator, sample_image_path, sample_output_path):
    ...
    def test_small_image_quality_settings_applied(self, sample_image_path, sample_output_path):
    ...
    def test_generate_small_image_permission_error(self, small_image_generator, sample_image_path, sample_output_path):
    ...
    def test_generate_small_image_io_error(self, small_image_generator, sample_image_path, sample_output_path):
        ...
        with patch('app.services.thumbnail_pipeline.generators.small_image_generator.validate_image_file') as mock_validate:
            ...
            with patch('PIL.Image.open') as mock_open:
                ...
                assert result.get('success') is False
                assert 'i/o' in result['error'].lower() or 'operation failed' in result['error'].lower()

    # ============================================================================
    # SCHEDULER INTEGRATION TESTS
    # ============================================================================

    def test_small_image_generation_scheduler_integration(self, small_image_generator, sample_image_path, sample_output_path):
    ...
    def test_small_image_generation_priority_handling(self, small_image_generator, sample_image_path, sample_output_path):
    ...
    def test_small_image_vs_thumbnail_size_difference(self, sample_image_path, sample_output_path):

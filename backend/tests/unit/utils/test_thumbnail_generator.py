...
class TestThumbnailGenerator:
    ...
    def test_generate_thumbnail_success(self, thumbnail_generator, sample_image_path, sample_output_path):
        """Test successful thumbnail generation."""
        # Mock the validation and generation process
        with patch('app.services.thumbnail_pipeline.generators.thumbnail_generator.validate_image_file') as mock_validate:
            ...
            with patch('PIL.Image.open') as mock_open:
                ...
                mock_img.resize.assert_called_once_with((200, 150), Image.Resampling.LANCZOS)
                mock_resized.save.assert_called_once()

    def test_generate_thumbnail_invalid_source(self, thumbnail_generator, sample_output_path):
    ...
    def test_generate_thumbnail_pil_error(self, thumbnail_generator, sample_image_path, sample_output_path):
    ...
    def test_generate_thumbnail_creates_output_directory(self, thumbnail_generator, sample_image_path, temp_dir):
    ...
    def test_thumbnail_aspect_ratio_handling(self, thumbnail_generator, sample_output_path):
        ...
        for width, height in test_sizes:
            with patch('app.services.thumbnail_pipeline.generators.thumbnail_generator.validate_image_file') as mock_validate:
                ...
                with patch('PIL.Image.open') as mock_open:
                    ...
                    assert result.get('success') is True
                    mock_img.resize.assert_called_with((200, 150), Image.Resampling.LANCZOS)

    # ============================================================================
    # BATCH PROCESSING TESTS
    # ============================================================================

    def test_generate_thumbnail_with_metadata(self, thumbnail_generator, sample_image_path, sample_output_path):
    ...
    def test_generate_thumbnail_permission_error(self, thumbnail_generator, sample_image_path, sample_output_path):
    ...
    def test_generate_thumbnail_disk_space_error(self, thumbnail_generator, sample_image_path, sample_output_path):
    ...
    def test_generate_thumbnail_performance_tracking(self, thumbnail_generator, sample_image_path, sample_output_path):
    ...
    def test_thumbnail_quality_settings_applied(self, sample_image_path, sample_output_path):
    ...
    def test_thumbnail_generation_scheduler_integration(self, thumbnail_generator, sample_image_path, sample_output_path):

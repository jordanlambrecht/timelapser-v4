...
class TestOverlayRouterIntegration:
    ...
    def test_get_overlay_presets_success(self, test_client, mock_overlay_service_responses):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_service:
            ...
            mock_overlay_service.get_overlay_presets.return_value = mock_overlay_service_responses["all_presets"]
    ...
    def test_get_overlay_presets_filtered_builtin_only(self, test_client, mock_overlay_service_responses):
    ...
    def test_get_overlay_preset_by_id_success(self, test_client, mock_overlay_service_responses):
        """Test successful retrieval of specific preset."""
        with patch('app.dependencies.get_overlay_service') as mock_service:
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.get_overlay_preset_by_id.return_value = mock_overlay_service_responses["builtin_presets"][0]
            mock_service.return_value = mock_overlay_service
    ...
    def test_create_overlay_preset_success(self, test_client, mock_overlay_service_responses):
        """Test successful preset creation."""
        with patch('app.dependencies.get_overlay_service') as mock_service:
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.validate_overlay_configuration.return_value = True
            mock_overlay_service.create_overlay_preset.return_value = mock_overlay_service_responses["custom_preset"]
            mock_service.return_value = mock_overlay_service
    ...
    def test_update_overlay_preset_success(self, test_client, mock_overlay_service_responses):
        """Test successful preset update."""
        with patch('app.dependencies.get_overlay_service') as mock_service:
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.get_overlay_preset_by_id.return_value = mock_overlay_service_responses["custom_preset"]
            mock_overlay_service.validate_overlay_configuration.return_value = True
    ...
    def test_update_builtin_preset_forbidden(self, test_client, mock_overlay_service_responses):
    ...
    def test_delete_overlay_preset_success(self, test_client, mock_overlay_service_responses):
    ...
    def test_delete_builtin_preset_forbidden(self, test_client, mock_overlay_service_responses):
    ...
    def test_get_timelapse_overlay_config_success(self, test_client, mock_overlay_service_responses):
        """Test successful retrieval of timelapse overlay configuration."""
        with patch('app.dependencies.get_overlay_service') as mock_service:
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.get_timelapse_overlay_config.return_value = mock_overlay_service_responses["timelapse_config"]
            mock_service.return_value = mock_overlay_service
    ...
    def test_create_timelapse_overlay_config_success(self, test_client, mock_overlay_service_responses):
        """Test successful timelapse overlay configuration creation."""
        with patch('app.dependencies.get_overlay_service') as mock_service:
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.validate_overlay_configuration.return_value = True
            mock_overlay_service.create_or_update_timelapse_overlay_config.return_value = mock_overlay_service_responses["timelapse_config"]
            mock_service.return_value = mock_overlay_service
    ...
    def test_update_timelapse_overlay_config_success(self, test_client, mock_overlay_service_responses):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_service:
            ...
            mock_overlay_service.update_timelapse_overlay_config.return_value = updated_config
            mock_service.return_value = mock_overlay_service
    ...
    def test_delete_timelapse_overlay_config_success(self, test_client, mock_overlay_service_responses):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_service:
            ...
            # Verify service was called
            mock_overlay_service.delete_timelapse_overlay_config.assert_called_once_with(1)

    # ============================================================================
    # ASSET MANAGEMENT ENDPOINT TESTS
    # ============================================================================

    def test_get_overlay_assets_success(self, test_client, mock_overlay_service_responses):
        """Test successful retrieval of overlay assets."""
        with patch('app.dependencies.get_overlay_service') as mock_service:
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.get_overlay_assets.return_value = mock_overlay_service_responses["assets"]
            mock_service.return_value = mock_overlay_service
    ...
    def test_upload_overlay_asset_success(self, test_client, mock_overlay_service_responses):
        """Test successful asset upload."""
        with patch('app.dependencies.get_overlay_service') as mock_service, \
             patch('app.utils.validation_helpers.process_overlay_asset_upload') as mock_process:
            
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.upload_overlay_asset.return_value = mock_overlay_service_responses["assets"][0]
            mock_service.return_value = mock_overlay_service
            ...
            # Make request
            response = test_client.post("/api/overlays/assets/upload", files=files, data=data)
    ...
    def test_get_overlay_asset_file_success(self, test_client, mock_overlay_service_responses):
        """Test successful asset file serving."""
        with patch('app.dependencies.get_overlay_service') as mock_service, \
             patch('app.utils.file_helpers.validate_file_path') as mock_validate, \
             patch('pathlib.Path.exists') as mock_exists:
            
            # Setup mock service
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.get_overlay_asset_by_id.return_value = mock_overlay_service_responses["assets"][0]
            mock_service.return_value = mock_overlay_service
    ...
    def test_delete_overlay_asset_success(self, test_client, mock_overlay_service_responses):
    ...
    def test_generate_overlay_preview_success(self, test_client):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_overlay_service_dep, \
             patch('app.dependencies.get_overlay_job_service') as mock_job_service_dep:
            
            # Setup mock services
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.validate_overlay_configuration.return_value = True
            mock_overlay_service.generate_overlay_preview.return_value = type('OverlayPreviewResponse', (), {
                'success': True,
    ...
    def test_capture_fresh_photo_for_preview_success(self, test_client):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_overlay_service_dep, \
             patch('app.dependencies.get_scheduler_service') as mock_scheduler_dep, \
             patch('pathlib.Path.exists') as mock_exists:
            
            # Setup mock services
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.capture_fresh_photo_for_preview.return_value = "/tmp/temp_camera_1.jpg"
            
            mock_scheduler_service = AsyncMock()
            mock_scheduler_service.schedule_immediate_capture.return_value = {"success": True}
            ...
            mock_overlay_service.capture_fresh_photo_for_preview.assert_called_once_with(1)
    ...
    def test_get_overlay_system_status_success(self, test_client, mock_overlay_service_responses):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_overlay_service_dep, \
            ...
            mock_job_service = AsyncMock(spec=SyncOverlayJobService)
            mock_job_service.get_job_statistics.return_value = type('OverlayJobStatistics', (), {
                'pending_jobs': 5,
                'processing_jobs': 2,
    ...
    def test_invalid_request_validation(self, test_client):
        ...
        response = test_client.post("/api/overlays/presets", json={
            "name": "",  # Empty name
    ...
    def test_service_error_handling(self, test_client):
        ...
        with patch('app.dependencies.get_overlay_service') as mock_service:
            ...
            mock_overlay_service = AsyncMock(spec=OverlayIntegrationService)
            mock_overlay_service.get_overlay_presets.side_effect = Exception("Database connection failed")
            mock_service.return_value = mock_overlay_service

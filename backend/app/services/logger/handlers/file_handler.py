...
class FileHandler:
    ...
    def __init__(
        self,
        log_directory: str = "/tmp/timelapser_logs",
        base_filename: str = "timelapser",
    ...
    def _setup_current_log_file(self) -> None:
        ...
        try:
            ...
            if self.use_json_format:
                current_log_path = self.log_directory / f"{self.base_filename}_{timestamp}.jsonl"
            else:
                current_log_path = self.log_directory / f"{self.base_filename}_{timestamp}.log"
    ...
    def reset_health(self) -> None:
        ...
        try:
            ...
            if not hasattr(self, '_current_log_path') or not self._current_log_path.exists():
                self._initialize_logging()
        except Exception as e:

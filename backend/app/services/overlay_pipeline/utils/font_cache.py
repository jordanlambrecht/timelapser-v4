...
class GlobalFontCache:
    ...
    @classmethod
    def _load_font_with_fallback(cls, font_family: str, size: int) -> ImageFont.FreeTypeFont:
    ...
    @classmethod
    def get_text_metrics(cls, text: str, font_family: str, size: int) -> Tuple[int, int]:
        """

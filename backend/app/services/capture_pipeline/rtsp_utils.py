...
def configure_rtsp_capture(cap: cv2.VideoCapture, timeout_seconds: int = DEFAULT_RTSP_TIMEOUT_SECONDS) -> None:
    """
...
def capture_frame_from_rtsp(
    rtsp_url: str, timeout_seconds: int = DEFAULT_RTSP_TIMEOUT_SECONDS, skip_frames: int = 3
) -> Optional[Any]:
    """
